# ---------------------------------------------------------
# Washington State Data Breach Analysis
# This script analyzes data breaches in Washington State, focusing on the number of breaches and people affected by industry type.
...
def main():
    ...
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig("Hypothesis3/Hypothesis3_Plots/total_affected_bar_plot.png")
    plt.show()
    ...
    plt.xticks(rotation=45, ha='right')
    plt.tight_layout()
    plt.savefig("Hypothesis3/Hypothesis3_Plots/waff_boxplot_log.png")
    plt.show()
